...
namespace UWPWithWin32
{
    ...
    sealed partial class App : Application
    {
        ...
        public App()
        {
            ...
            string pfm = Windows.ApplicationModel.Package.Current.Id.FamilyName;
        ...
        /// <summary>
        /// AppService 在 Win10 16299 開始支援 Sinle Process 的做法，利用 OnBackgroundActivated 來處理 AppService 的請求。
        /// </summary>
        ...
        private void OnAppServicesCanceled(IBackgroundTaskInstance sender, BackgroundTaskCancellationReason reason)
        {
            appServiceDeferral?.Complete();
            appServiceConnection?.Dispose();
            sender.Canceled -= OnAppServicesCanceled;
        }
    }
}